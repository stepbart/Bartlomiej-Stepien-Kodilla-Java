...
class BookDirectoryTestSuite {
    ...
    @Test
    void testListBooksInHandsOfIfUserHasNoBooksInHands() {

        // Given
        LibraryUser libraryUser = new LibraryUser("Jan","Kowalski","99121200000");
    ...
    @Test
    void testListBooksInHandsOfIfUserHasOneBooksInHands() {
    ...
    @Test
    void testListBooksInHandsOfIfUserHasFiveBooksInHands() {
        ...
        Book book5 = new Book("Java", "John Kovalsky", 2021);
        resultListOfBooks.add(book1);
