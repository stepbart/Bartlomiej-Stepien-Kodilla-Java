...
import static com.kodilla.sudoku.SudokuRow.addElementsToSection;
...
public class SudokuBoard extends Prototype<SudokuBoard>{
    ...
    public static SudokuBoard newBoard(){
        ...
        for (SudokuRow sudokuRow : sudokuBoard.getRowList()){
            for (int i = 0 ; i<9 ; i++){
                sudokuBoard.columnList.get(i).addElementToList(sudokuRow.getElementList().get(i));
            }
        }
    ...
    public static SudokuBoard deepCopy(SudokuBoard sudokuBoard)  {
        ...
        for (int i = 0; i < 9; i++) {
            ...
            for (int n = 0; n < 9; n++) {
                ...
                sudokuRow.addElementToList(sudokuElement);
